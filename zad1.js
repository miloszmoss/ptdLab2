...
class DFT extends Base {
  ...
  init() {
    ...
    this.printData('data/zad1.txt', JSON.stringify(zad1Data));
    this.printPNG(figZad1, imgOpts, 'charts/zad1.png');
    // zad2_a
    ...
    this.printData('data/zad2-a.txt', JSON.stringify(zad2_A_Data));
    this.printPNG(figZad2A, imgOpts, 'charts/zad2-a.png');
    // zad2_b
    ...
    this.printData('data/zad2-b.txt', JSON.stringify(zad2_B_Data));
    this.printPNG(figZad2B, imgOpts, 'charts/zad2-b.png');
    // zad3
    ...
    this.printData('data/zad3.txt', JSON.stringify(zad3Data));
    this.printPNG(figZad3, imgOpts, 'charts/zad3.png');
    //zad4_a
    ...
    this.printData('data/zad4-a.txt', JSON.stringify(zad4_A_Data));
    this.printPNG(figZad4A, imgOpts, 'charts/zad4-a.png');
    // zad4_b
    ...
    this.printData('data/zad4-b.txt', JSON.stringify(zad4_B_Data));
    this.printPNG(figZad4B, imgOpts, 'charts/zad4-b.png');
    // zad4_c
    ...
    this.printData('data/zad4-c.txt', JSON.stringify(zad4_C_Data));
    this.printPNG(figZad4C, imgOpts, 'charts/zad4-c.png');
  }
}
